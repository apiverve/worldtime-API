# World Time API - Examples

This folder contains example code for using the World Time API across different platforms.
...
const response = await fetch('https://api.apiverve.com/v1/worldtime', {
...
response = requests.get('https://api.apiverve.com/v1/worldtime',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/worldtime](https://docs.apiverve.com/ref/worldtime)
