...
```bash
curl -X GET "https://api.apiverve.com/v1/worldtime?param=value" \
...
📚 **Full API Documentation:** [https://docs.apiverve.com/ref/worldtime](https://docs.apiverve.com/ref/worldtime)

---

## Use Cases

Common use cases for the World Time API:
